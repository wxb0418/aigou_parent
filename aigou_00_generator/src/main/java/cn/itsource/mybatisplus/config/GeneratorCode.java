...
public class GeneratorCode {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //获取classpath下的文件 generator.properties
        ...
        gc.setAuthor(rb.getString("author"));// wxb
        ...
        focList.add(new FileOutConfig("/templates/controller.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                //E:\\software\\ideaIU\\work_space\\mybatis_plus_parent\\mybatis_plus_generator\\src\\main
                return rb.getString("OutputDir")+ "/cn/itsource/web/controller/" + tableInfo.getControllerName() + ".java";
            }
        });
        // 调整 query 生成目录演示
        focList.add(new FileOutConfig("/templates/query.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                //E:\\software\\ideaIU\\work_space\\mybatis_plus_parent\\mybatis_plus_generator\\src\\main
                return rb.getString("OutputDir")+ "/cn/itsource/query/" + tableInfo.getEntityName()+ "Query.java";
            }
        });
